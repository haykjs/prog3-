...
class eatEatGrass {
 ...
 mul() {
        ...
        if (cord) {
            ...
            //ստեղծում է նոր օբյեկտ (այստեղ խոտակեր) 
            //և տեղադրում է այն խոտակերների զանգվածի մեջ
            var norgishat = new eatEatGrass(x, y, this.index);
            eaterArr.push(norgishat);
...
mul() {
    ...
    if (cord) {
        ...
        //ստեղծում է նոր օբյեկտ (այստեղ խոտակեր) 
        //և տեղադրում է այն խոտակերների զանգվածի մեջ
        var norgishat = new eateaterGrass(x, y, this.index);
        eateaterArr.push(norgishat);
